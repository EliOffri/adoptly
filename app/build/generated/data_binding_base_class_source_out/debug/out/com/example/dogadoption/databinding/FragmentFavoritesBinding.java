...
public final class FragmentFavoritesBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textEmptyFavorites;

  private FragmentFavoritesBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView recyclerViewFavorites, @NonNull TextView textEmptyFavorites) {
    this.rootView = rootView;
    this.recyclerViewFavorites = recyclerViewFavorites;
    this.textEmptyFavorites = textEmptyFavorites;
  }
  ...
  public static FragmentFavoritesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.text_empty_favorites;
      TextView textEmptyFavorites = ViewBindings.findChildViewById(rootView, id);
      if (textEmptyFavorites == null) {
        break missingId;
      }

      return new FragmentFavoritesBinding((ConstraintLayout) rootView, recyclerViewFavorites,
          textEmptyFavorites);
    }
