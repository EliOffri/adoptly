...
public abstract class Hilt_BreedDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BreedDetailFragment() {
    super();
  }

  Hilt_BreedDetailFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BreedDetailFragment_GeneratedInjector) this.generatedComponent()).injectBreedDetailFragment(UnsafeCasts.<BreedDetailFragment>unsafeCast(this));
    }
  }
