...
public abstract class Hilt_AdoptionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdoptionFragment() {
    super();
  }

  Hilt_AdoptionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdoptionFragment_GeneratedInjector) this.generatedComponent()).injectAdoptionFragment(UnsafeCasts.<AdoptionFragment>unsafeCast(this));
    }
  }
