...
public abstract class Hilt_ReportStrayFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReportStrayFragment() {
    super();
  }

  Hilt_ReportStrayFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReportStrayFragment_GeneratedInjector) this.generatedComponent()).injectReportStrayFragment(UnsafeCasts.<ReportStrayFragment>unsafeCast(this));
    }
  }
