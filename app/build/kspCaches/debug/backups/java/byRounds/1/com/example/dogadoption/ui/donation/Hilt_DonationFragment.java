...
public abstract class Hilt_DonationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DonationFragment() {
    super();
  }

  Hilt_DonationFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DonationFragment_GeneratedInjector) this.generatedComponent()).injectDonationFragment(UnsafeCasts.<DonationFragment>unsafeCast(this));
    }
  }
